...
function outputDistance(status, body) {
    if (body) {
        const distance = body.getDistanceBetweenBodyParts3D(bodyPartsList.rightShoulder, bodyPartsList.rightWrist)
...
function drawWrists(canvas, body) {
    if (body) {
        ...
        const leftWrist = body.getBodyPart2D(bodyPartsList.rightWrist)
        const rightWrist = body.getBodyPart2D(bodyPartsList.rightHip)
